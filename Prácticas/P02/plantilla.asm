...
;-----[ ENCABEZADO ]-----
; Proyecto:	P0102
; Created:	23/08/2019 11:00:45 a. m.
; Author :	Sergio F Hernández Machuca
; Alumna: Martha Diana Ramírez Torres
;******************************************************************************
;	Revisar en:
...
;		[.cseg] 0x000000 0x00009e    158      0    158   32768   0.5%
...
Ciclo:
	...
	call delayXms						; Retardo de tiempo (verificar)
	cbi PORTB,0							; El bit "0" de PORTB puesto a "0"
	;Led verde agregado a otro pin
	call delayXms						; Retardo en tiempo (calcular con herramienta)
